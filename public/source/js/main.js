...
(function ($) {
    ...
    try {
        ...
        var arrowSubMenu = $('.arrow-sub-menu-m');                          ///////THÊM//////

        for(var i=0; i<arrowSubMenu.length; i++){                           ///////THÊM//////
            $(arrowSubMenu[i]).on('click', function(){
                $(this).parent().find('.sub-sub-menu-m').slideToggle();
                $(this).toggleClass('turn-arrow-main-menu-m');
            })
        }
    ...
    try {
        $('#d-s').on('click', function(){
            var s= document.getElementById('desktop-search');
        ...
        $('#m-s').on('click', function(){
            var s= document.getElementById('mobile-search');
            if(s.getAttribute('style')!='display:none')
                s.setAttribute('style','display:none');
            else
                 s.setAttribute('style','display:block');
